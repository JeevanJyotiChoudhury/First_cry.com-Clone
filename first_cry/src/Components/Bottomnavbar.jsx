            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem>
                  <Image
                    width="60%"
                    src="https://cdn.fcglcdn.com/brainbees/images/n/desktop_drop_down_girl_winter_271022.jpg"
                  />
                </MenuItem>
                <MenuItem
                  onClick={() => {
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem>
                  <Image
                    width="60%"
                    src="https://cdn.fcglcdn.com/brainbees/images/n/desktop_drop_down_footwear_winter_271022.jpg"
                  />
                </MenuItem>
                <MenuItem
                  onClick={() => {
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem>
                  <Image
                    width="60%"
                    src="https://cdn.fcglcdn.com/brainbees/images/n/desk_menu_toy_07012021.jpg"
                  />
                </MenuItem>
                <MenuItem
                  onClick={() => {
          ...
          <Box>
            <Menu>
              ...
              <MenuList>
                ...
                >
                  Cold Relief/Nasal Balms & Inhalers
                </MenuItem>
                <MenuItem
                  onClick={() => {
                    handleNavigation("/products/Footwear");
