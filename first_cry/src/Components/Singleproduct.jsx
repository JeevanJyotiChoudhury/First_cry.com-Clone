...
const Singleproduct = () => {
  ...
  console.log(product);
  let discount = Math.round(((product.strike_price - product.price)/product.strike_price)*100)
    ...
    <Flex w="85%"  m="20px auto" >
      ...
      <Box w="60%"  pl={6} pt={5}>
        ...
        <Text fontSize="md" color="gray.500">
          New Born, Snug V neck tee with front buttons and elastic waist pajama
          for boys Product ID: 9109882 - <span color="blue">See Details</span>
        </Text>
        <br />
        <hr />
        <Flex w="52%" pt={4}>
        ...
        <Flex mt={6} justify={"space-between"} w={"40%"}>
          <Box><Button onClick={handleAdd} colorScheme='blue'>Add to Cart</Button></Box>
          <Box><Link to="/cart"><Button colorScheme='blue'>Go to Cart</Button></Link></Box>
        </Flex>
        <Box mt={6}>
        ...
        <Flex className="offerscontainer" border="apx solid green" mt={5}>
                        <Box w={"20%"} m={"auto"}>
                            ...
                            <Text fontSize='sm' p="0 5px" >Exclusive Offers & Discounts</Text>
                        </Box>
                        <Box w={"20%"} m={"auto"}>
                            <Image src="https://cdn.fcglcdn.com/brainbees/images/price_benefit_member.webp"/>
                            <Text fontSize='sm' p="0 5px" >Lower Prices on Products</Text>
                        </Box>
                        <Box w={"20%"} m={"auto"}>
                            <Image src="https://cdn.fcglcdn.com/brainbees/images/earn_loyalty_cash.webp"/>
                            <Text fontSize='sm' p="0 5px" >Loyalty Cash Points</Text>
                        </Box>
                        <Box w={"20%"} m={"auto"}>
                            <Image src="https://cdn.fcglcdn.com/brainbees/images/baby_gear_assembly.webp"/>
                            <Text fontSize='sm' p="0 5px" >Free baby gear assembly</Text>
                        </Box>
                        <Box w={"20%"} m={"auto"}>
                            <Image src="https://cdn.fcglcdn.com/brainbees/images/lower_shipping_barrier.webp"/>
                            <Text fontSize='sm' p="0 5px" >Lower Shipping barrier</Text>
                        </Box>
                    </Flex>
                    <hr style={{marginTop:"30px"}}/>
                    <Flex className='Extradetails' justify="space-between">
                       <Box><p>TENTATIVE DELIVERY</p></Box>
                       <Box><p>Cash on Delivery Available </p></Box>
                       
                       <Box><p>30 days Return or Exchange</p></Box>
                    </Flex>
      </Box>
    </Flex>
    <Box bg="tomato" h="30px"><Text textAlign="center" color="white">Big store for little ones</Text></Box>
    </>
  );
};
